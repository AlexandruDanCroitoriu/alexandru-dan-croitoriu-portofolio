...
/*! \class TailwindThemeBase Wt/TailwindThemeBase.h Wt/TailwindThemeBase.h
 *
 ...
 */
class TailwindThemeBase : public Wt::WTheme
{
public:
  /*! \brief Constructor.
   *
  ...
  virtual void apply(Wt::WWidget *widget, Wt::DomElement& element, int elementRole)
    const override;
